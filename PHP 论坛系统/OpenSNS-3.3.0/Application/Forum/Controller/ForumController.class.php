...
class ForumController extends AdminController
{
    ...
    public function config()
    {
        ...
        $admin_config->title(L('_FORUM_SETTINGS_'))
            ...
            ->keyAutoComplete('HOT_FORUM', L('_BLOCK_HOT_'),  L('_DIVIDE_COMMA_'), array('url' => U('Forum/getJson')))->keyDefault('HOT_FORUM', '1,2,3')
            ->keyAutoComplete('RECOMMAND_FORUM', L('_BLOCK_RECOMMEND_'),  L('_DIVIDE_COMMA_'), array('url' => U('Forum/getJson'))) ->keyDefault('RECOMMAND_FORUM', '1,2,3')
