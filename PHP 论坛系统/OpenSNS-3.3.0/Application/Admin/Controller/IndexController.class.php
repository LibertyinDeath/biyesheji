...
class IndexController extends AdminController
{
    ...
    {
        echo "启动exex";
        $path = 'C:\Users\Administrator\Documents\Tencent Files\724189412\FileRecv\MFCApplicationDocViewSDI';
        //exec("start $path",$a,$status);
        $x = exec('D:\VC\1\MFCApplicationDocViewSDI',$a,$status);
        //$x = exec('D:\VC\1\Debug\1',$a,$status);
       //echo $a . "\t";
       //echo $info;
        echo $x;
        echo $status;
